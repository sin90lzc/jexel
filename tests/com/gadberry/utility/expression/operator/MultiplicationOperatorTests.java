...
public class MultiplicationOperatorTests extends TestCase {
	...
	public void testResolve1() {
		...
		try {
			...
			assertEquals(op.resolve(null).toDouble(), 32d);
	...
	public void testResolve3() {
		...
		try {
			op.setArguments(args);
			assertEquals(op.resolve(null).toDouble(), 15d);
		} catch (InvalidArgumentsException e) {
			e.printStackTrace();
			fail();
		} catch (ArgumentCastException e) {
	...
	public void testResolve5() {
		...
		try {
			op.setArguments(args);
			assertEquals(op.resolve(null).toDouble(), 275d);
		} catch (InvalidArgumentsException e) {
			e.printStackTrace();
			fail();
		} catch (ArgumentCastException e) {
	...
	public void testResolve6() {
		...
		try {
			op.setArguments(args);
			assertEquals(op.resolve(null).toDouble(), -0.165d);
		} catch (InvalidArgumentsException e) {
			e.printStackTrace();
			fail();
		} catch (ArgumentCastException e) {
